  ...
  else
  {
   ...
   $description = $_POST['description'];
    ...
    $stmt = $pdo->prepare("INSERT INTO categories(name,description) VALUES(:name,:description)");
        ...
        if($result)
        {
            echo '<script>alert("New category is successfully created ! ");window.location.href="categories.php";</script>';
        }
   }
              ...
              <div class="card-body">
                <form method="POST" action="cat_add.php">
                  ...
                  <input type="hidden" name="_token" value="<?php echo $_SESSION['_token']; ?>">
                    ...
                    <a href="categories.php" type="button" class="btn btn-secondary mt-3">Cancel</a>
                </form>
              <!-- /.card-body -->
